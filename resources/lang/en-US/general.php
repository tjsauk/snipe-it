...
return [
    ...
    'all'       			=> 'All',
    'archived'              => 'Archived',
    'asset_models'			=> 'Asset Subcategories',
    'asset_model'			=> 'Asset Subcategory',
    'asset'					=> 'Asset',
    ...
    'bulk_reserve'          => 'Bulk Reserve',
    'bulk_reserve_success'  => 'Reservations created successfully for :count asset(s).',
    'bulk_reserve_partial'  => 'Reservations created for :ok/:total assets. Some assets had no available periods in the selected time range.',
    'bulk_checkin'          => 'Bulk Checkin',
    'bulk_checkin_success'  => ':count asset(s) checked in successfully.',
    'select_dates'          => 'Select Dates',
    'select_dates_in_calendar' => 'Drag a period in the calendar to the right to set the reservation dates.',
    'basket_add'            => 'Add to Basket',
    'basket_add_multiple'   => 'Add to Basket',
    'basket_added_multiple' => ':count asset(s) added to basket.',
    'basket_remove'         => 'Remove from Basket',
    'basket_added'          => ':name added to basket.',
    'basket_removed'        => ':name removed from basket.',
    'basket_cleared'        => 'Basket cleared.',
    'basket_empty'          => 'Basket is empty',
    'basket_count'          => '{1} :count asset in basket|[2,*] :count assets in basket',
    'basket_reserve'        => 'Reserve from Basket',
    ...
    'manufacturers'			=> 'Subcategory Manufacturers',
    ...
    'restored'				=> 'restored',
    'restore'				=> 'Restore',
    'requestable_models'    => 'Requestable Subcategoriess',
    ...
    'select_manufacturer'	=> 'Select a Subcategory Manufacturer',
    'select_model'			=> 'Select a Subcategory',
    'select_supplier'		=> 'Select a Asset Manufacturer',
    ...
    'supplier'              => 'Asset Manufacturer',
    'suppliers'  			=> 'Asset Manufacturers',
    ...
    'no_requestable' => 'There are no requestable assets or asset Subcaterogies.',
    ...
    'use_cloned_no_image_help' => 'This item does not have an associated image and instead inherits from the subcategory or category it belongs to. If you would like to use a specific image for this item, you can upload a new one below.',
...
// Add form placeholders here
    ...
    'bulk_delete_associations' => [
        ...
        'asset_models_no_count'       => ':item_name is currently associated with other asset subcategorys and cannot be deleted. Please update your assets to no longer reference this :item and try again.',
    ...
    'generic_model_not_found' => 'That :subcategory was not found or you do not have permission to access it',
    'deleted_models' => 'Deleted Asset Subcategories',
